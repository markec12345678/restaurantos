...
import { Flame, ChefHat, Clock, CheckCircle2, Zap, Layers } from 'lucide-react'
...
const STATUS_CONFIG: Record<string, { color: string; bg: string; label: string; icon: React.ReactNode }> = {
  ...
  served: { color: 'text-gray-500', bg: 'bg-gray-50 dark:bg-gray-900/30', label: 'Postreženo', icon: <CheckCircle2 className="h-4 w-4" /> },
}
