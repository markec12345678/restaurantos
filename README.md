# RestaurantOS v1.22.0

[![Version](https://img.shields.io/badge/version-1.22.0-86702b?style=flat-square)](https://github.com/markec12345678/restaurantos/releases)
...
### 🔒 Hardening v v1.22.0 (QA runde 85–108 — tenant scope kanon + ordering tokeni + 429 kanon + dvostopenjska prijava + deploy forenzika + WebAuthn fundacija + E2E v CI + Prisma query validacija + WebAuthn prijava + atomarni counter guard + multi-origin allowlist + koncurenčni WRITE tokovi + HR/darilne kartice concurrency + qr-pay/blagajna concurrency + nabavni prevzem concurrency + zalogovni pisalni kanon + time-off CAS/loyalty točkovni kanon + naročila/mize pisalni kanon + outbox retry CAS)
