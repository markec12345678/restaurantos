// ============================================
// FINA DEMO CA VERIGA — javni demo certifikati za CIS TESTNO okolje
// ============================================
// Vir: certs/cis-test/demo-ca-bundle.pem (Fina Demo Root CA + Demo CA 2020)
// JAVNI demo CA-ji — ni skrivnosti. Inlined namesto fs read, da ne sproži
// whole-project tracinga na Vercelu (lekcija Task 18).
// Testni CIS strežnik ima privatno demo hierarhijo → privzeti trust store
// je ne prepozna ("unable to verify the first certificate").

export const CIS_TEST_CA_PEM = [
  // Fina Demo Root CA
  `-----BEGIN CERTIFICATE-----
