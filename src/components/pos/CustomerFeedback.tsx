...
import { Star, MessageSquare, ThumbsUp, TrendingUp, Send, Filter, Users, Sparkles, Frown, Meh, Smile, Zap } from 'lucide-react'
...
// ─── Emotikon za oceno ──────────────────────────────────────────
const RatingEmoji = memo(function RatingEmoji({ rating }: { rating: number }) {
              ...
              {[
                ...
                <div key={key}>
                  ...
                  <div className="flex gap-1 mt-1">
                    {[1, 2, 3, 4, 5].map(n => {
                      const currentRating = Number((newFeedback as Record<string, unknown>)[key] ?? 0)
                      return (
                        <button
                          key={n}
