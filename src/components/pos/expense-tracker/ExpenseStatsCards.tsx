  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
      <Card><CardContent className="p-4">
        ...
        <p className="text-2xl font-bold">{formatEUR(stats?.totalExpenses || 0)}</p>
      </CardContent></Card>
      <Card><CardContent className="p-4">
        ...
        <p className="text-2xl font-bold">{formatEUR(stats?.recurringExpenses || 0)}</p>
      </CardContent></Card>
      <Card><CardContent className="p-4">
      ...
      <Card><CardContent className="p-4">
        ...
        <p className="text-2xl font-bold">{formatEUR(avgExpense)}</p>
      </CardContent></Card>
    </div>
  )
})
