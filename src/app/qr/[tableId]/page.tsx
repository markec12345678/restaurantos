...
import { ShoppingCart, Plus, Minus, Trash2, ChevronRight, Check, UtensilsCrossed, Phone, User, MessageSquare, AlertCircle, Loader2, X, Globe, Bell, Search } from 'lucide-react'
...
const allergenLabels: Record<string, string> = {
  ...
  '7': '🥛',  // Mleko (Milk)
  '8': '🌰',  // Oreški (Tree nuts)
  '9': '🥬',  // Zelenina/Celer (Celery)
  '10': '🟡', // Gorčica (Mustard)
  '11': '⚪', // Sezam (Sesame)
  '12': '🧪', // Sulfiti (Sulphites)
  '13': '🫘',  // Volčji bob (Lupin)
...
export default function QROrderingPage({ params }: { params: Promise<{ tableId: string }> }) {
  ...
  const detailModalRef = useFocusTrap<HTMLDivElement>(!!detailItem)
