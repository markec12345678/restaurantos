...
// ============================================
// Calendar classNames — namenski razredi za DayPicker
// ============================================
...
// ============================================
// Calendar components — Root, Chevron, WeekNumber
// ============================================

export function CalendarRoot({ className, rootRef, ...props }: React.ComponentPropsWithoutRef<"div"> & { rootRef?: React.Ref<HTMLDivElement> }) {
  return (
    <div
      data-slot="calendar"
      ref={rootRef}
...
export function CalendarChevron({ className, orientation, ...props }: React.ComponentPropsWithoutRef<"svg"> & { orientation?: string }) {
  if (orientation === "left") {
...
export function CalendarWeekNumber({ children, ...props }: React.ComponentPropsWithoutRef<"td">) {
  return (
    <td {...props}>
