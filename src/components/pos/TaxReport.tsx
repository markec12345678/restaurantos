...
import { FileText, Calculator, Calendar, Receipt, BarChart3, Shield, AlertCircle, CheckCircle } from 'lucide-react'
...
export const TaxReport = memo(function TaxReport() {
  ...
  const loadReport = async () => {
    ...
    try {
      ...
      toast.error('Napaka pri nalaganju davčnega poročila')
    } finally {
      setLoading(false)
    }
  }
