...
async function main() {
  ...
  let added = 0;
  // Pravilno mapiranje slik — vsak artikel dobi sliko ki res ustreza njegovemu opisu
  const imageMap = {
    ...
    'Svinjska pečenka': '/menu-images/glavne-jedi/svinjska-pecenka.png',
    'Panna cotta': '/menu-images/sladice/panna-cotta.png',
    'Kuhana zelenjava': '/menu-images/priloge/kuhana-zelenjava.png',
    'File brancina': '/menu-images/ribje-jedi/file-brancina.png',
  };
  ...
  for (const item of newItems) {
    ...
    // FIX: Uporabi pravilno mapirano sliko namesto slug-generiranega path-a
    ...
    added++;
    console.log('  ADDED: ' + item.name + ' - €' + item.price + (image ? ' ✅' : ' ⚠️ no image'));
  }
