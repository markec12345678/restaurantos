...
export const FursManager = memo(function FursManager() {
  ...
  const [testResult, setTestResult] = useState<{ success: boolean; message?: string; error?: string; isSimulation?: boolean; zoi?: string; eor?: string; responseTime?: number; validationErrors?: ValidationErrorRow[] } | null>(null)
            ...
            <div className={`p-4 rounded-xl border ${
              ...
              {testResult.validationErrors && (
                <div className="mt-2 space-y-1">
                  {testResult.validationErrors.map((e: ValidationErrorRow, i: number) => (
