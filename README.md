...
│                      │                                      │
│  ┌──────────────┐   │   ┌──────────────────────────┐       │
│  │  POS App     │   │   │  API Routes (68 modulov)  │       │
│  │  (63 komp.)  │◄──┼──►│  - Auth + Permissions     │       │
│  │              │   │   │  - Zod Validation         │       │
│  │  ┌────────┐  │   │   │  - Prisma Transactions    │       │
│  │  │Zustand │  │   │   └──────────┬───────────────┘       │
│  │  │Store   │  │   │              │                       │
│  │  └────────┘  │   │   ┌──────────▼───────────────┐       │
│  │              │   │   │  Prisma ORM (69 modelov)  │       │
│  │  ┌────────┐  │   │   └──────────┬───────────────┘       │
│  │  │TanStack│  │   │              │                       │
│  │  │Query   │  │   │   ┌──────────▼───────────────┐       │
│  │  └────────┘  │   │   │  SQLite Database          │       │
...
restaurantos/
├── prisma/
│   └── schema.prisma          # 69 Prisma modelov (1868 vrstic)
├── src/
│   ├── app/
│   │   ├── api/               # 68 API modulov (130+ rut)
...
## 🗃️ Podatkovni model (69 Prisma modelov)
...
| Prisma $transaction | Atomski operaciji za kritične transakcije (naročila, plačila) |
...
| POS komponent | 64 |
| API modulov | 68 (130+ rut) |
| Prisma modelov | 69 |
| Javni strani | 10 |
| Jezikov | 5 (800+ ključev vsak) |
