...
import { Trophy, TrendingUp, DollarSign, Clock, Users, Star, BarChart3, Timer, UtensilsCrossed, ArrowDownRight, Award, Zap, Target, Coffee, ChefHat, Wine } from 'lucide-react'
...
export const StaffPerformance = memo(function StaffPerformance() {
  ...
  // Most tips, fastest, best upseller
