...
export default function KDSError({
  ...
  useEffect(() => {
    logger.error('KDS', 'Napaka pri nalaganju kuhinjskega zaslona', {
  ...
  return (
    <div className="p-8 sm:p-10 max-w-xl mx-auto">
      <h2 className="text-destructive text-xl font-semibold">Napaka — Kuhinjski zaslon</h2>
      <p className="text-foreground/90 mt-2">Prišlo je do napake pri nalaganju kuhinjskega zaslona. Poskusite znova.</p>
      {error?.digest && (
