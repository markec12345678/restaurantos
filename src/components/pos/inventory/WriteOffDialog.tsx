      ...
      <DialogContent className="max-w-md">
        ...
        {selectedItem && (
          <div className="bg-red-50 dark:bg-red-900/20 rounded-lg p-3 mb-3 space-y-1 text-sm">
            ...
            <p className="text-muted-foreground">Trenutna zaloga: <span className="font-medium">{selectedItem.quantity} {selectedItem.unit}</span> (vrednost: {formatEUR(selectedItem.quantity * selectedItem.costPerUnit)})</p>
          </div>
        )}
