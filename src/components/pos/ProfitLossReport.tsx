...
import { TrendingUp, TrendingDown, DollarSign, BarChart3, ArrowUpRight, ArrowDownRight, FileText, Calculator, Receipt, Package, Users, Home, Building } from 'lucide-react'
interface PnLData {
  period: string
  periodStart: string
  periodEnd: string
