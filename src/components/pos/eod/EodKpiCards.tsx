    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
      <Card>
        <CardContent className="p-3">
          ...
          <p className="text-xl font-bold text-emerald-600">{formatEUR(data.orders.revenue)}</p>
        </CardContent>
      </Card>
      <Card>
        <CardContent className="p-3">
      ...
      <Card>
        <CardContent className="p-3">
          ...
          <p className="text-xl font-bold text-amber-600">{formatEUR(data.payments.totalTips)}</p>
        </CardContent>
      </Card>
      <Card>
        <CardContent className="p-3">
      ...
      <Card>
        <CardContent className="p-3">
          ...
          <p className="text-xl font-bold text-red-600">{formatEUR(data.expenses.total)}</p>
        </CardContent>
      </Card>
    </div>
  )
