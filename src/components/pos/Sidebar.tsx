...
import { LayoutDashboard, ShoppingCart, BarChartBig, UtensilsCrossed, Package, Users, BarChart3, ChefHat, Wallet, Sun, Moon, Menu, X, Store, ShieldCheck, BookOpen, Settings, SlidersHorizontal, Truck, CreditCard, Award, Printer, Webhook, CalendarDays, Maximize, Minimize, Monitor, ExternalLink, HandMetal, Brain, LayoutGrid, Calendar, UserCircle, Sparkles, Calculator, ClipboardList, Factory, Plug, MapPin, CalendarClock, Layers, MessageSquare, Target, FileText, HandCoins, Navigation, Timer, Trophy, Bell, ShieldAlert, Receipt, ClipboardCheck, BellRing, PieChart, Activity, Table2, CookingPot, Scale, Star, Trash2, Scale3d } from 'lucide-react'
import { useTheme } from 'next-themes'
import { useSyncExternalStore, useState, useEffect, useMemo, useCallback, memo } from 'react'
...
// Hook: reaktivno stanje uporabnika — prebere sessionStorage enkrat, posluša 'pos:auth-expired' dogodek
...
export const Sidebar = memo(function Sidebar() {
  ...
  // Hover prefetch — prednaloži podatke ob hoverju nad gumbom modula
  const { onModuleHover } = useSidebarHoverPrefetch()
  // FIX BUG-06: Odstranjen unused _locale — usePOSStore().locale že sproži re-render ob spremembi
  ...
  // Memoizirana filtriranja navigacijskih elementov — ne kliče getCurrentUser() na vsakem renderju
