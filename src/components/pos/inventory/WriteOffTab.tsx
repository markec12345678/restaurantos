            ...
            <div className="space-y-3">
              ...
              {selectedItem && (
                <div className="bg-muted/50 rounded-lg p-3 space-y-1 text-sm">
                  ...
                  <div className="flex justify-between"><span className="text-muted-foreground">Nabavna vrednost:</span><span className="font-medium">{formatEUR(selectedItem.quantity * selectedItem.costPerUnit)}</span></div>
                </div>
              )}
            </div>
                ...
                {selectedItem && writeOffData.quantity && (() => {
                  ...
                  return (
                    <div className="text-xs text-muted-foreground mt-1 space-y-0.5">
                      ...
                      <p>Strošek odpisa: <span className="font-medium text-red-600">{formatEUR(costLoss)}</span></p>
                    </div>
                  )
                })()}
              </div>
