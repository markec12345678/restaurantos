# RestaurantOS v1.13.0

[![Version](https://img.shields.io/badge/version-1.13.0-86702b?style=flat-square)](https://github.com/markec12345678/restaurantos/releases)
...
[![Tests](https://img.shields.io/badge/tests-3444%20unit%20%2B%209%20integracija%20%2B%20210%20E2E-3c7a50?style=flat-square)](tests/)
...
**Test napredek:** 2495 (R84) → 3242 (R94) → 3315 (R95) → 3347 (R96) → 3410 unit / 189 datotek (R97) → 3416 unit / 190 datotek (R98) → **3444 unit / 193 datotek (R99)** + 9/9 integracija + **210/210 E2E v CI**.
