...
import { ChefHat, Clock, Maximize, Minimize, RefreshCw, Wifi, WifiOff, Flame, CheckCircle2, AlertTriangle, Grid3X3, List, Volume2, VolumeX, RotateCcw } from 'lucide-react'
...
// ─── PIN Login ─────────────────────────────────────────────────
function KDSLogin({ onLogin }: { onLogin: (_emp: { id: string; name: string; role: string }) => void }) {
