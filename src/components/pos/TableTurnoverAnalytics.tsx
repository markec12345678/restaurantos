...
import {
  LayoutGrid, Clock, TrendingUp, Users, ArrowUpRight,
  ArrowDownRight, Timer, UtensilsCrossed, AlertTriangle,
  CheckCircle2, Zap, Coffee,
} from 'lucide-react'
...
export function TableTurnoverAnalytics() {
