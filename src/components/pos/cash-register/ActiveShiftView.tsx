        ...
        <CardContent className="p-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <p className="text-xl font-bold">{formatEUR(activeShift.startingCash)}</p>
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          <Card>
            <CardContent className="p-4">
              ...
              <p className="text-xl font-bold">{formatEUR(liveStats.cashSales)}</p>
              <p className="text-[10px] text-muted-foreground mt-1">
                Pričakovano: {formatEUR(liveStats.expectedCash)}
              </p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-4">
              ...
              <p className="text-xl font-bold">{formatEUR(liveStats.cardSales)}</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-4">
              ...
              <p className="text-xl font-bold">{formatEUR(liveStats.mobileSales)}</p>
            </CardContent>
          </Card>
          <Card className="border-primary/20">
            <CardContent className="p-4">
              ...
              <p className="text-xl font-bold text-primary">{formatEUR(liveStats.totalSales)}</p>
              <p className="text-[10px] text-muted-foreground mt-1">
          ...
          <CardContent>
            <div className="space-y-2">
              <div className="flex items-center justify-between py-2 px-3 rounded-lg bg-muted/50">
                ...
                <span className="font-semibold">{formatEUR(liveStats.cashSales)}</span>
              </div>
              <div className="flex items-center justify-between py-2 px-3 rounded-lg bg-muted/50">
                <div className="flex items-center gap-2">
                  <CreditCard className="h-4 w-4 text-blue-600" />
                ...
                <span className="font-semibold">{formatEUR(liveStats.cardSales)}</span>
              </div>
              <div className="flex items-center justify-between py-2 px-3 rounded-lg bg-muted/50">
                <div className="flex items-center gap-2">
                  <Smartphone className="h-4 w-4 text-purple-600" />
                ...
                <span className="font-semibold">{formatEUR(liveStats.mobileSales)}</span>
              </div>
              <div className="flex items-center justify-between py-2 px-3 rounded-lg bg-muted/50">
                <div className="flex items-center gap-2">
                ...
                <span className="font-semibold">{formatEUR(liveStats.splitPayments)}</span>
              </div>
              <Separator />
              <div className="flex items-center justify-between py-2 px-3 rounded-lg bg-primary/5">
                ...
                <span className="font-bold text-lg">{formatEUR(liveStats.totalSales)}</span>
              </div>
              {liveStats.totalDiscounts > 0 && (
                <div className="flex items-center justify-between py-2 px-3 rounded-lg">
                  ...
                  <span className="text-sm text-rose-600">-{formatEUR(liveStats.totalDiscounts)}</span>
                </div>
              )}
            </div>
          </CardContent>
