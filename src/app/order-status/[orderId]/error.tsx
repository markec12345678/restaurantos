...
export default function Error({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  useEffect(() => {
    logger.error('OrderStatus', 'Napaka pri nalaganju statusa naročila', {
  ...
  return (
    <div className="p-8 sm:p-10 max-w-xl mx-auto">
      ...
      <p className="text-foreground/90 mt-2">Prišlo je do napake pri nalaganju statusa naročila.</p>
