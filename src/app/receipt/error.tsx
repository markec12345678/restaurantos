...
export default function Error({
  ...
  useEffect(() => {
    logger.error('ReceiptPage', 'Napaka pri nalaganju računa', {
  ...
  return (
    <div className="p-8 sm:p-10 max-w-xl mx-auto">
      ...
      <button
        onClick={reset}
        className="bg-primary text-primary-foreground rounded-lg px-6 py-2.5 font-medium min-h-[44px] cursor-pointer hover:opacity-90 transition-opacity mt-5"
      >
        Poskusi znova
      </button>
    </div>
