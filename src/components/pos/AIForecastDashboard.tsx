...
import { TrendingUp, TrendingDown, Minus, AlertTriangle, ShieldCheck, Package, ShoppingCart, BarChart3, Brain, Zap, Clock, RefreshCw, CheckCircle2 } from 'lucide-react'
              ...
              {reorders.map(r => {
                ...
                return (
                  <Card
                    ...
                    onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); toggleItem(r.inventoryItemId) } }}
                  >
